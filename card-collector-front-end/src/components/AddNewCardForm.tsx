        ...
        <section className="add-card-form">
            ...
            </fieldset>
            {
                ...
                (<section className="card-form__player">
                    <label>Card name<input onChange={(event) => updatePlayers(event, 1, "firstname") } type="text" placeholder="ex. Welcome" defaultValue={""} required /></label>
                    <label>Card name<input onChange={(event) => updatePlayers(event, 1, "lastname") } type="text" placeholder="ex. To" defaultValue={""} /></label>
                    <label>Team name<input onChange={(event) => updatePlayers(event, 1, "teamname") } type="text" placeholder="ex. Las Vegas" defaultValue={""} /></label>
